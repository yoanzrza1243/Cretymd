...
function title() {
    console.log(chalk.bold.green(figlet.textSync('itsuka botz', {
        font: 'Standard',
...
function uncache(module = '.') {
    ...
    const haruka = harukaConnect({
      version,
        ...
        browser: ['itsuka botz','Safari','1.0.0'],
        auth: state
    })
